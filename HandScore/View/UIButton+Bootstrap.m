...
-(void)grayStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:204/255.0 green:204/255.0 blue:205/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:70/255.0 green:184/255.0 blue:218/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:204/255.0 green:204/255.0 blue:205/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
