...
- (void)initCompentWithFrame:(CGRect)frame {
	_selectContentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, frame.size.width - 41, 57)];
	_selectContentLabel.font = [UIFont systemFontOfSize:18.0f];
    _selectContentLabel.textAlignment = UITextAlignmentCenter;
//	_selectContentLabel.backgroundColor = [UIColor clearColor];
	...
	[_pulldownButton setFrame:CGRectMake(frame.size.width - 41, 0, 41, 37)];
	[_pulldownButton setBackgroundImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"down_arrow" ofType:@"png"]]
...
//	_hiddenButton.backgroundColor = [UIColor clearColor];
	...
	_comboBoxTableView = [[UITableView alloc] initWithFrame:CGRectMake(1, 26, frame.size.width -2, 300)];
